...
export default function Titlebar(): JSX.Element {
  ...
  return (
    ...
    >
      {/* Left — App Branding */}
      <div className="flex items-center gap-2 no-drag min-w-0" style={{ WebkitAppRegion: 'no-drag' as unknown as string }}>
      ...
      {/* Center — Current View */}
      <div className="absolute left-1/2 -translate-x-1/2 no-drag" style={{ WebkitAppRegion: 'no-drag' as unknown as string }}>
      ...
      <div className="flex items-center no-drag" style={{ WebkitAppRegion: 'no-drag' as unknown as string }}>
        <button
